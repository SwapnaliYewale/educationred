                        ...
                        <section class="col-lg-6 connectedSortable">
                            ...
                            <div class="box box-success">
                                ...
                                <div class="box-body chat" id="chat-box">
                                    ...
                                    <div class="item">
                                        <img src="<?php echo base_url();?>assets/admin/img/avatar.png" alt="user image" class="online"/>
                                        <p class="message">
                                            <a href="#" class="name">
                                    ...
                                    <div class="item">
                                        <img src="<?php echo base_url();?>assets/admin/img/avatar2.png" alt="user image" class="offline"/>
                                        <p class="message">
                                            <a href="#" class="name">
                                    ...
                                    <div class="item">
                                        <img src="<?php echo base_url();?>assets/admin/img/avatar3.png" alt="user image" class="offline"/>
                                        <p class="message">
                                            <a href="#" class="name">
